...
const { runConverter } = require(require('../helpers/plugin-paths').artifactPath('skills/create-discord-emoji-gif/scripts/node/converter-runner'));
const gifski = require(require('../helpers/plugin-paths').artifactPath('skills/create-discord-emoji-gif/scripts/node/mov-to-gif-gifski'));
const gifsicle = require(require('../helpers/plugin-paths').artifactPath('skills/create-discord-emoji-gif/scripts/node/mov-to-gif'));
