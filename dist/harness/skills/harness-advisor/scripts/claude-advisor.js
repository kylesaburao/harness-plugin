...
function fail(code, condition, remedy = HELP) {
...
function parseArguments(argv) {
    if (argv.some(arg => arg === '--workspace' || arg.startsWith('--workspace='))) {
        fail('usage_error', '--workspace is no longer supported; Harness Advisor uses executor-supplied evidence only.', 'Remove --workspace and its value; include the material source excerpts and results in --prompt.');
    }
    const options = {};
