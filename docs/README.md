...
- [Install Claude Code or Codex integration](../README.md#install).
...
Start with the [development overview](development/README.md), then use the focused references:

- [Dependencies](development/dependencies.md): required runtimes and tools.
