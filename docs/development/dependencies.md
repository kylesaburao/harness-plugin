...
| `write-implementation-plan` | Instruction-only, no dedicated runtime or package. Uses available host capabilities; execution-time handoff needs access to a permitted durable destination. No initialization artifact is required. |
