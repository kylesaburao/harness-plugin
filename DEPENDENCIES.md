...
| Node.js and npm | Node.js **22.12.0 or newer** satisfies the highest Node minimum across the full test gate, including backup's `archiver` integration. npm installs the backup dependencies. |
