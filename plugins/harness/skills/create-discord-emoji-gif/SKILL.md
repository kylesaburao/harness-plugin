...
needs `gifski`. The fallback needs `gifsicle`.
...
4. Ask the user before installing anything. `brew install ffmpeg gifski` and
   `brew install ffmpeg gifsicle` modify the machine.
